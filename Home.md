...
Игроки свободно перемещаются по карте в соответствии со своими реальными географическими координатами. Учетная запись игрока жестко
привязана к этим конкретным коордианатам.

Игроки могут реализовать себя в игре в соответствии со своими интересами:
...
Станция -- это статичное сооружение, жестко привязанное к финсированным координатам и созданное на основе ["стационарной платформы"](#stationary_platform).
