...
- Атаковать указанных юнитов (станции, роботы) в указанном порядке.
                                                                   
- Защищать указанного юнита (станцию, робота, игрока) - атака агрессора, нападающего на подзащитного.
